...
class Article extends BaseController
{
        ...
        if ($this->request->getMethod() == "post") {
            ...
            $aturan = [
                ...
                'post_thumbnail' => [
                    ...
                    'errors' => [
                        'is_image' => 'Hanya gambar yang diperbolehkan diupload'
                    ]
                ]
            ];
                ...
                if ($aksi != false) {
                    ...
                    if ($file->getName()) {
                        if ($dataPost['post_thumbnail']) {
                            @unlink(LOKASI_UPLOAD . "/" . $dataPost['post-thumnail']);
                        }
    ...
    function siswa()
    {
        ...
        $data['templateJudul'] = 'Halaman Siswa';
        $post_type = $this->halaman_controller;
        $jumlahBaris = 3;
        $katakunci = $this->request->getVar('katakunci');
        $group_dataset = 'dt';
    ...
    function siswa_tambah()
    {
        ...
        /** Header */
        echo view("admin/v_template_header", $data);
        echo view("admin/siswa_tambah", $data);
        /** Footer */
        echo view("admin/v_template_footer", $data);
    }
}